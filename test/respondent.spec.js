...
describe('Respondents', function () {
    ...
    xdescribe('Respondents get', function () {
        ...
        it('should get respondents which equal samples', (done) => {
            request
                ...
                .expect(200, function (err, res) {
                    ...
                    assert.equal(JSON.stringify(respondent), `{"user":{"userName":"thirdUserNAme","userDescription":"thirdUserNAme description","lastVisited":"25.09","lastTested":"21.09"},"testName":{"name":"Тест по Git. Начальный уровень","lastEdited":"12","numberOfQuestions":"123"},"tryCount":"2","points":"32","time":"11:25"}`);
                    if (err) {
                        console.log('err', err);
                        console.log('res', res.body);
                    }
    ...
    describe('Respondents post', function () {
        xit('should return status code 400 if object not valid', (done) => {
            request
                .post('/respondents')
                .send({name: 'qwe'})
        ...
        xit('should return status code 200 if object valid', (done) => {
            request
                .post('/respondents')
                .send({
                    user: {
